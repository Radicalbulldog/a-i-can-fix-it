    ...
    <form onSubmit={handleSubmit} className="flex items-end gap-2">
      ...
      <div className="flex-1 relative">
        ...
        <input
          ...
          disabled={disabled}
          className="w-full px-4 py-2.5 rounded-full border border-gray-300 focus:border-brand-500 focus:ring-2 focus:ring-brand-200 outline-none text-sm bg-white disabled:opacity-50"
        />
      </div>
