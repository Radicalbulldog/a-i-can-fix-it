      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <span className="text-xs text-gray-500">{contractor.rating} ({contractor.reviewCount} reviews)</span>
          </div>
        ...
        <div className="flex-shrink-0 text-right">
          <div className="text-xs text-gray-400 mb-2">{contractor.distance.toFixed(1)} mi</div>
          <a
